...
public class Result_admin_q4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(Result_admin_q4.this, DisplayListVIewQ4.class);
                intent.putExtra("Json_data", Json);
                startActivity(intent);
                Result_admin_q4.this.finish();
            }
        }, 7000);
    }
