...
public class Result_Q2 extends ArrayAdapter {

    private List list = new ArrayList();
    private Context c;

    public Result_Q2(Context context, int resource) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (row == null) {
            ...
            playerHolder = (Result_Q2.PlayerHolder) row.getTag();
        }
