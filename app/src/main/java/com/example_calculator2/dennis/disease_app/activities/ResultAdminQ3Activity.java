...
import com.example_calculator2.dennis.disease_app.listView.DisplayListViewQ3;
...
public class ResultAdminQ3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_result_admin_q3);
        ...
        getResultQuestThree(disease_id);
    }


    private void getResultQuestThree(String user_id) {
        if (user_id == null) {
            Toast.makeText(this, "Invalid input!", Toast.LENGTH_LONG).show();
            return;
        }

        Call<JsonArray> jsonCall = api.getResultQuestThree(user_id);
        jsonCall.enqueue(new Callback<JsonArray>() {
            ...
            public void onResponse(Call<JsonArray> call, Response<JsonArray> response) {
                ...
                new Handler().postDelayed(new Runnable() {
                    @Override
                    public void run() {
                        Intent intent = new Intent(ResultAdminQ3Activity.this, DisplayListViewQ3.class);
