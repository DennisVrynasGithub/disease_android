...
public class Result_admin_q6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_result_admin_q6);
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(Result_admin_q6.this, DisplayListViewQ6.class);
                intent.putExtra("Json_data", Json);
                startActivity(intent);
                Result_admin_q6.this.finish();
            }
        }, 7000);
    }
