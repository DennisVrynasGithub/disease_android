...
public class Result_admin_q3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(Result_admin_q3.this, DisplayListViewQ3.class);
                intent.putExtra("Json_data", Json);
                startActivity(intent);
                Result_admin_q3.this.finish();
            }
        }, 7000);
    }
