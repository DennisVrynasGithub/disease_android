...
import com.example_calculator2.dennis.disease_app.adapter.Result_Q2;
...
public class DisplayListViewQ2 extends AppCompatActivity {
   ...
   Result_Q2 playerAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_display_list_view_q2);

        //Receive Json
        Json_string = getIntent().getExtras().getString("Json_data");
        listView = findViewById(R.id.listview_q2);
        playerAdapter = new Result_Q2(this, R.layout.activity_row_q2);
