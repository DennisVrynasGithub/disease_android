...
public class Result_admin_q1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Intent intent = new Intent(Result_admin_q1.this, DisplayListViewQ1.class);
                intent.putExtra("Json_data", Json);
                startActivity(intent);
                Result_admin_q1.this.finish();
            }
        }, 7000);
    }
    ...
    private class BackgroundWorker extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... params) {
            String login_url = "http://83.212.101.67:80/admin_q1.php";
            try {
