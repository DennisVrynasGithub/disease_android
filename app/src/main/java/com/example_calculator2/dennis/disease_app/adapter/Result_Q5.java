...
public class Result_Q5 extends ArrayAdapter {
    private List list = new ArrayList();
    private Context c;

    public Result_Q5(Context context, int resource) {
    ...
    public View getView(int position, View convertView, @NonNull ViewGroup parent) {
        ...
        if (row == null) {
            ...
            playerHolder = (Result_Q5.PlayerHolder) row.getTag();
        }
