...
import com.example_calculator2.dennis.disease_app.adapter.Result_Q6;
...
public class DisplayListViewQ6 extends AppCompatActivity {

    String Json_string;
    JSONObject jsonObject;
    JSONArray jsonArray;
    Result_Q6 playerAdapter;
    ListView listView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_display_list_view_q6);

        //Receive Json
        Json_string = getIntent().getExtras().getString("Json_data");
        listView = findViewById(R.id.listview_q6);
        playerAdapter = new Result_Q6(this, R.layout.activity_row_q2);
